...
export const EmptyRecommendations: React.FC = () => (
  <Card className="text-center" padding="lg">
    ...
    <p className="text-secondary text-sm max-w-md mx-auto mb-6 leading-relaxed">
      Complete our travel quiz and we&apos;ll match you with Nigerian
      destinations that fit your budget, climate preferences, and activities.
    </p>
